...
import 'package:githubapi/screens/widgets/error.dart';
import 'package:githubapi/screens/widgets/loading.dart';
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(repo[i]['name'].toString(),style: TextStyle(color: Colors.white,fontSize: 18),overflow: TextOverflow.clip,),
                                Text(repo[i]['full_name'].toString(),style: TextStyle(color: Colors.white),overflow: TextOverflow.clip,),
                                SizedBox(height: 10,),
                                Row(children: [
                                  Container(
